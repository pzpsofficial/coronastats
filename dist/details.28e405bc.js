...
},{"moment":"node_modules/moment/moment.js"}],"scripts/details.js":[function(require,module,exports) {
"use strict";
...
var getData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(country) {
    var res1, res2, res3, data1, data2, data3;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            transformedLabels = data[0].map(function (element) {
              return element['Date'].slice(0, 10);
            });
            transformedDataRecovered = data[1].map(function (element) {
              return element['Cases'];
            });
            transformedDataDeaths = data[2].map(function (element) {
              return element['Cases'];
            });
            ctx = document.getElementById('myChart').getContext('2d');
            myChart = new _chart.default(ctx, {
              type: 'line',
              data: {
                labels: _toConsumableArray(transformedLabels),
                datasets: [{
                  label: 'Total confirmed cases',
                  data: _toConsumableArray(transformedDataConfirmed),
                  ...
                  data: _toConsumableArray(transformedDataRecovered),
                  ...
                  data: _toConsumableArray(transformedDataDeaths),
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/details.js"], null)
//# sourceMappingURL=/details.28e405bc.js.map